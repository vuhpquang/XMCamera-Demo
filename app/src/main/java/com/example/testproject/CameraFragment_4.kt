 ...
 * Use the [CameraFragment_4.newInstance] factory method to
 * create an instance of this fragment.
 */
class CameraFragment_4 : Fragment(), MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener,
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_camera_4, container, false)
        init(view)
        return view
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CameraFragment_4.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CameraFragment_4().apply {
