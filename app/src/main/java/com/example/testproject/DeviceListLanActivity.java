...
import com.basic.G;
import com.example.testproject.ListAdapterFunDevice.OnFunDeviceItemClickListener;
 ...
 * 5. 退出并注销监听
 */
public class DeviceListLanActivity extends ActivityDemo implements OnClickListener, OnFunDeviceListener, OnFunDeviceItemClickListener, OnAddSubDeviceResultListener {
