...
public final class Detector {
  ...
  private void extractParameters(ResultPoint[] bullsEyeCorners) throws NotFoundException {
    ...
    // bullsEyeCorners[shift] is the aisee_corner of the bulls'eye that has three
    // orientation marks.  
    // sides[shift] is the row/column that goes from the aisee_corner with three
    // orientation marks to the aisee_corner with two.
  ...
  private static int getRotation(int[] sides, int length) throws NotFoundException {
    ...
    // aisee_corner. Since the four rotation values have a Hamming distance of 8, we
  ...
  /**
   * Expand the square represented by the aisee_corner points by pushing out equally in all directions
   *
