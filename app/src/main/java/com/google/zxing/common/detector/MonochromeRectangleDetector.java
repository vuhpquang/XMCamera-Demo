...
public final class MonochromeRectangleDetector {
  ...
  /**
   * Attempts to locate a aisee_corner of the barcode by scanning up, down, left or right from a center
   ...
   *  the barcode
   * @return a {@link com.google.zxing.ResultPoint} encapsulating the aisee_corner that was found
