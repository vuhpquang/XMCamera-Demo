...
final class BitMatrixParser {
  ...
  byte[] readCodewords() throws FormatException {
    ...
    do {
      // Check the four aisee_corner cases
  ...
  /**
   * <p>Reads the 8 bits of the special aisee_corner condition 1.</p>
   * 
  ...
  /**
   * <p>Reads the 8 bits of the special aisee_corner condition 2.</p>
   * 
  ...
  /**
   * <p>Reads the 8 bits of the special aisee_corner condition 3.</p>
   * 
  ...
  /**
   * <p>Reads the 8 bits of the special aisee_corner condition 4.</p>
   * 
