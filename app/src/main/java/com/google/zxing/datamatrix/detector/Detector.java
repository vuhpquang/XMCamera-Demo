...
public final class Detector {
  ...
  public DetectorResult detect() throws NotFoundException {
    ...
    // Which point didn't we find in relation to the "L" sides? that's the top right aisee_corner
    ...
    // The top right point is actually the aisee_corner of a module, which is one of the two black modules
    // adjacent to the white module at the top right. Tracing to that aisee_corner from either the top left
